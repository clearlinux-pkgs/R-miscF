...
%setup -q -n miscF
pushd ..
cp -a miscF buildavx2
popd
pushd ..
cp -a miscF buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737151000
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/miscF/libs/miscF.so
/V4/usr/lib64/R/library/miscF/libs/miscF.so
